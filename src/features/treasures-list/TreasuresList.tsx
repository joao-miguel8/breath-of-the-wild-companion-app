...
export default function TreasuresList({ treasuresData, loadingTreasures, handleChosenTreasureCard, toggleChosenCard }: { treasuresData: treasureCardType[]; loadingTreasures: boolean; handleChosenTreasureCard: (card: ChosenTreasureCardType) => void; toggleChosenCard: UseToggleType }) {
