...
function SelectedTreasureCard({ chosenTreasureCard, cardToggle }: { chosenTreasureCard: ChosenTreasureCardType; cardToggle: () => void }) {
    ...
    return (
        <div className={classNames("h-full w-full sticky top-40 overflow-scroll bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-neutral-900 via-zinc-900 to-stone-800 scrollbar-none scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-200 border-4 border-accent")}>
            {/* close button */}
